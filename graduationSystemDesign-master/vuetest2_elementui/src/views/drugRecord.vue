...
export default {
  ...
  methods: {
    ...
    findMessage() {
      ...
      if (this.input1) {
        if (this.currentId == 1) {
          const _this = this;
          axios
            .post("http://localhost:8181/medicineSalesHandler/findByName/" + _this.input1)
            .then(function (resp) {
              //console.log(resp);
          ...
          axios
            .post(
              "http://localhost:8181/medicineSalesHandler/findByProvider/" + _this.input1
            )
            .then(function (resp) {
              //console.log(resp);
              _this.tableData = resp.data;
    ...
    resetRow() {
      const _this = this;
      axios.post("http://localhost:8181/medicineSalesHandler/findAll").then(function (resp) {
        console.log(resp);
        alert("请重新查找");
        _this.input1 = null;
        _this.tableData = resp.data;
